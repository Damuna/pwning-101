...
- Rubeus ticket (kirbi ticket in B64)
	- `{bash} cat out.kirbi| base64 -w0 | xclip -se c` -> copy to clipboard
### PFX Certificates
...
## Admins & special accounts
- Domain Admin -> Trust Escalation, DCSync, NTDS
	-  Built in the local administrator of the domain controller
	- DC Machine Account
	- krbtgt service account
- Local Admin -> Lsass, sam, lsa, dpapi
- Service Account -> Silver Tickets -> impersonate Administrator on the service
	- Every account with an SPN
